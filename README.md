...
| `GetEnhancements`  | Retrieve enhancement implementations for ABAP programs or includes. Automatically detects object type. | `object_name` (string): Name of the program or include | `@tool GetEnhancements object_name=SD_SALES_DOCUMENT_VIEW` or `@tool GetEnhancements object_name=mv45afzz` |
