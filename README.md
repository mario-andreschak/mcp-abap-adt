...
| ------------------ | ------------------------------------------- | ----------------------------------------------------------------- | ----------------------------------------------------------------- |
| `GetProgram`       | Retrieve ABAP program source code.          | `program_name` (string): Name of the ABAP program. <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `@tool GetProgram program_name=ZMY_PROGRAM filePath=/path/to/file.txt` |
| `GetClass`         | Retrieve ABAP class source code.            | `class_name` (string): Name of the ABAP class. <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `@tool GetClass class_name=ZCL_MY_CLASS filePath=/path/to/file.txt` |
| `GetFunctionGroup` | Retrieve ABAP Function Group source code.   | `function_group` (string): Name of the function group <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `@tool GetFunctionGroup function_group=ZMY_FUNCTION_GROUP filePath=/path/to/file.txt` |
| `GetFunction`      | Retrieve ABAP Function Module source code.  | `function_name` (string), `function_group` (string) <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `@tool GetFunction function_name=ZMY_FUNCTION function_group=ZFG filePath=/path/to/file.txt` |
| `GetStructure`     | Retrieve ABAP Structure.                    | `structure_name` (string): Name of the DDIC Structure. <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `@tool GetStructure structure_name=ZMY_STRUCT filePath=/path/to/file.txt` |
| `GetTable`         | Retrieve ABAP table structure.              | `table_name` (string): Name of the ABAP DB table. <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `@tool GetTable table_name=ZMY_TABLE filePath=/path/to/file.txt` |
| `GetTableContents` | Retrieve contents of an ABAP table.         | `table_name` (string), `max_rows` (number, optional, default 100) <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `@tool GetTableContents table_name=ZMY_TABLE max_rows=50 filePath=/path/to/file.txt` |
| `GetPackage`       | Retrieve ABAP package details.              | `package_name` (string): Name of the ABAP package. <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `@tool GetPackage package_name=ZMY_PACKAGE filePath=/path/to/file.txt` |
| `GetTypeInfo`      | Retrieve ABAP type information.             | `type_name` (string): Name of the ABAP type. <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `@tool GetTypeInfo type_name=ZMY_TYPE filePath=/path/to/file.txt` |
| `GetInclude`       | Retrieve ABAP include source code           | `include_name` (string): name of the ABAP include <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `@tool GetInclude include_name=ZMY_INCLUDE filePath=/path/to/file.txt` |
| `SearchObject`     | Search for ABAP objects using quick search. | `query` (string), `maxResults` (number, optional, default 100) <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `@tool SearchObject query=ZMY* maxResults=20 filePath=/path/to/file.txt` |
| `GetInterface`     | Retrieve ABAP interface source code.        | `interface_name` (string): Name of the ABAP interface. <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `@tool GetInterface interface_name=ZIF_MY_INTERFACE filePath=/path/to/file.txt` |
| `GetTransaction`   | Retrieve ABAP transaction details.          | `transaction_name` (string): Name of the ABAP transaction. <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `@tool GetTransaction transaction_name=ZMY_TRANSACTION filePath=/path/to/file.txt` |
| `GetEnhancements`  | 🔍 **ENHANCEMENT ANALYSIS**: Retrieve and analyze enhancement implementations in ABAP programs or includes. Automatically detects object type and extracts enhancement source code. Use `include_nested=true` for **COMPREHENSIVE RECURSIVE SEARCH** across all nested includes - finds ALL enhancements in the entire program hierarchy. <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `object_name` (string): Name of the program or include, `program` (string, optional): For includes, manually specify parent program if auto-detection fails, `include_nested` (boolean, optional): If true, performs recursive enhancement search in all nested includes <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `@tool GetEnhancements object_name=SD_SALES_DOCUMENT_VIEW filePath=/path/to/file.txt` or `@tool GetEnhancements object_name=mv45afzz program=SAPMV45A include_nested=true filePath=/path/to/file.txt` |
| `GetEnhancementImpl` | 📝 **ENHANCEMENT BY NAME**: Retrieve source code of a specific enhancement implementation by its name and enhancement spot. <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `enhancement_spot` (string): Name of the enhancement spot, `enhancement_name` (string): Name of the specific enhancement implementation <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `@tool GetEnhancementImpl enhancement_spot=enhoxhh enhancement_name=zpartner_update_pai filePath=/path/to/file.txt` |
| `GetEnhancementSpot` | Retrieve metadata and list of implementations for a specific enhancement spot. <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `enhancement_spot` (string): Name of the enhancement spot <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `@tool GetEnhancementSpot enhancement_spot=enhoxhh filePath=/path/to/file.txt` |
| `GetBdef` | Retrieve the source code of a BDEF (Behavior Definition) for a CDS entity. <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `bdef_name` (string): Name of the BDEF (Behavior Definition) <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `@tool GetBdef bdef_name=Z_I_MYENTITY filePath=/path/to/file.txt` |
| `GetIncludesInProgram` | List all includes in a given ABAP program. <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `program_name` (string): Name of the ABAP program <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `@tool GetIncludesInProgram program_name=SAPMV45A filePath=/path/to/file.txt` |
| `GetObjectsByType` | List ABAP objects by type. <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `object_type` (string): Type of object (e.g., class, program, include, etc.) <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `@tool GetObjectsByType object_type=class filePath=/path/to/file.txt` |
| `GetRelatedObjectTypes` | Retrieve related ABAP object types for a given object. <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `object_name` (string): Name of the ABAP object <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `@tool GetRelatedObjectTypes object_name=SAPMV45A filePath=/path/to/file.txt` |
| `GetSqlQuery` | **FREESTYLE SQL QUERIES**: Execute SQL queries via SAP ADT Data Preview API. Supports SELECT, WITH statements and other read-only SQL operations. <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `sql_query` (string): SQL query to execute, `row_number` (number, optional, default 100): Maximum number of rows to return <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `@tool GetSqlQuery sql_query="SELECT * FROM mara WHERE matnr LIKE 'TEST%'" row_number=50 filePath=/path/to/file.txt` |
| `GetIncludesList` | 📋 **INCLUDE INVENTORY**: Recursively discover and list ALL include files within an ABAP program or include. Performs code analysis to find include statements and builds a complete hierarchy. Use this when you need to understand the program structure. <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `object_name` (string): Name of the ABAP program or include, `object_type` (string): Type of object (program or include) <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `@tool GetIncludesList object_name=SAPMV45A object_type=program filePath=/path/to/file.txt` |
| `GetWhereUsed` | 🔍 **WHERE USED ANALYSIS**: Retrieve where-used references for ABAP objects via ADT usageReferences. Shows all places where a specific object (class, program, include, table, bdef, etc.) is used in the system. By default returns minimal relevant results, use detailed=true for complete analysis. <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `object_name` (string): Name of the ABAP object to search usages for, `object_type` (string): Type of object (e.g. class, program, include, function, interface, package, table/TABL, bdef/BDEF, etc.), `detailed` (boolean, optional): If true, returns all references including packages and internal components. Default is false (minimal results). <br>**Optional:** `filePath` (string): If provided, saves the result to the specified file. | `@tool GetWhereUsed object_name=RM07ALVI object_type=include filePath=/path/to/file.txt`, `@tool GetWhereUsed object_name=ZMY_TABLE object_type=table filePath=/path/to/file.txt`, `@tool GetWhereUsed object_name=Z_I_MYENTITY object_type=bdef filePath=/path/to/file.txt`, or `@tool GetWhereUsed object_name=CL_BUS_ABSTRACT_MAIN_SCREEN object_type=class detailed=true filePath=/path/to/file.txt` |
